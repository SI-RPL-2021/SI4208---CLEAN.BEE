...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('help') }}</h1>
            ...
            <div class="col-12 col-sm-8 mt-3 mt-sm-0">
                            ...
                            <div id="accordion" role="tablist">
                                        ...
                                        <div id="article_27000041359" class="collapse " role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                                            <div class="card-body"><ul><li><p dir="ltr">Transfer bank /<span style="color: rgb(61, 142, 185);"> <em>Bank transfer</em></span></p></li></ul><p dir="ltr">Jika Anda memilih metode pembayaran transfer bank, Anda dapat mentransfer pembayaran melalui transfer bank ke rekening Clean.Bee. Detail pembayaran akan dikirim melalui app, email dan sms setelah anda membuat pesanan.</p><p dir="ltr">Mohon lakukan pembayaran dalam kurun waktu yang tersedia dan pastikan anda mentransfer jumlah yang tepat.</p><p dir="ltr"><em><span style="color: rgb(61, 142, 185);">If you choose payment via bank transfer you will need to transfer your payment to Clean.Bee bank account. Payment details is sent after you make order through the app, email and sms.</span></em></p><p dir="ltr"><span style="color: rgb(61, 142, 185);"><em class="">Please make payment during the time and make sure you pay the same amount.</em></span></p><ul><li>Cash on Delivery</li></ul><p dir="ltr">Jika Anda memilih metode Cash on Delivery, Anda dapat melakukan pembayaran kepada spesialis kami saat pekerjaan telah selesai.</p><p dir="ltr"><em><span style="color: rgb(61, 142, 185);">If you choose payment via cash on delivery you may pay the job after our specialist done with job. </span></em></p><p><br></p></div>
                                        </div>
                                    </div>
                                                                    <div class="card">
                                        <div class="card-header" role="tab" id="headingOne">
